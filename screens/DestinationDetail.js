...
const IconLabel = ({ icon, label }) => {
  return(
    <View style={{ alignItems: 'center'}}>
      ...
      />
      <Text style={{ marginTop: SIZES.font, color: COLORS.gray, ...FONTS.h3 }}>{label}</Text>
    </View>
  )
}
...
const DestinationDetail = ({ navigation }) => {
  return (
    <View style={styles.container}>
        ...
        <View style={{ flex: 2}}>
          ...
          <View style={{ position: 'absolute', top: 50, left: 20, right: 20, flexDirection: 'row'}}>
             ...
             <View style={{ flex: 1, alignItems: 'flex-end' }}>
                <TouchableOpacity
                    onPress={() => console.log("Menu on press")}
                >
                    <Image 
                      source={icons.menu}
                      resizeMode="cover"
        ...
        <View style={{ flex: 1.5}}>
        {/** icons */}
          <View style={{ flexDirection:'row', marginTop: SIZES.padding * 2, paddingHorizontal: SIZES.padding * 2, justifyContent: 'space-between'}}>
            <IconLabel 
              icon={icons.villa}
              label="Villa"
            />
            ...
            >
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <TouchableOpacity 
                        ...
                        onPress={() => { console.log("Book on press")}}
                      >
                        <LinearGradient 
